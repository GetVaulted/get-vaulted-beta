...
export const OBS_HELP_ARTICLES: {
  ...
  },
  {
    ...
    body: [
      ...
      "Big delay: set OBS keyframe interval to 1 second, B-frames to 0, x264 Tune zerolatency. Then Refresh status in Stream settings (upgrades older IVS channels from NORMAL ~10–30s to LOW).",
