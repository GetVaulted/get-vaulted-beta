...
export const OBS_HELP_ARTICLES: {
...
}[] = [
  {
    ...
    body: [
      ...
      "Recommended: Settings → Output → Video bitrate 4500–6000 Kbps, keyframe interval 1–2 s (required for low delay), encoder x264 or NVENC.",
  ...
  },
  {
    ...
    body: [
      ...
      "Confirm Stream health shows Live. Buyers should see OBS video within a few seconds on low-latency HLS.",
  ...
  },
  {
    ...
    body: [
      "Invalid Path or Connection URL in OBS: Server must be rtmps://….live-video.net:443/app/ — tap Copy RTMPS URL again (Get Vaulted now copies it in that form).",
      ...
      "Big delay: OBS keyframe interval should be 1–2 seconds; Get Vaulted uses IVS low-latency HLS. Refresh status after Connect OBS so older channels upgrade to LOW latency.",
