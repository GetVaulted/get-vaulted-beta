    ...
    <>
      <div className={`relative ${imageAspect} w-full overflow-hidden`}>
        <div
          ...
          aria-hidden
        />
        <div className={`absolute inset-0 ${compact ? "p-2" : "p-2.5 sm:p-3"}`}>
        ...
        {vaultPick ? (
          <span className="pointer-events-none absolute left-3 top-3 z-10 inline-flex items-center gap-1 rounded-full border border-gold/40 bg-black/70 px-2 py-0.5 text-[8px] font-black uppercase tracking-[0.14em] text-gold-bright backdrop-blur-sm sm:text-[9px]">
