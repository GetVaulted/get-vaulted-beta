...
import { computeLiveLotReserveMet } from "./VaultPinnedLot";

// Legal/compliance audit (2026-07): the host's pinned-lot overlay previously showed "Reserve met"
// as soon as the current bid reached the lot's starting/listed price (priceUsd), not its actual
...
describe("computeLiveLotReserveMet", () => {
  ...
  it("is not fooled by a low starting price once a reserve is configured", () => {
    // A lot listed/starting at $10 with a $500 reserve should NOT show "met" at a $50 bid.
