...
/** Desktop buyer shell: 30% chat · 50% stage · 20% lineup */
export const BUYER_LIVE_DESKTOP_GRID =
  "grid h-full min-h-0 w-full max-w-[1920px] grid-cols-[minmax(0,30%)_minmax(0,50%)_minmax(0,20%)] gap-3 px-3 py-3 md:gap-3 md:px-4 md:py-3";
